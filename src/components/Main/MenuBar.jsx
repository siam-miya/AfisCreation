                            ...
                            {!isScrolled ? (
                                <div ref={categoryRef} className="w-full z-25 relative self-start">
                                    ...
                                    >
                                        ...
                                        <span>
                                            {isCategoryOpen ? <MdOutlineKeyboardArrowUp size={20} /> : <MdOutlineKeyboardArrowDown size={20} />}
                                        </span>
                                    </h2>
                    ...
                    <div className="p-4 bg-white relative">
                        ...
                        <div className="mt-6 bg-[#eb6e1b] rounded-2xl p-4 text-white flex items-center gap-4 shadow-md">
                            ...
                            <div className="min-w-0">
                                <h3 className="font-bold text-base font-poppins truncate">{user?.name ? user.name : "Hello there!"}</h3>
                                {user ? (
                                    <p className="text-xs text-white/90 truncate">{user.email}</p>
                                ) : (
                                    <Link href="/login" onClick={closeDrawer} className="text-xs text-white/90 underline hover:text-white">Login / Register</Link>
                                )}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 overflow-y-auto px-4 py-2">
                        ...
                        <div className="mt-5 mb-4">
                            ...
                            <div className="bg-white rounded-2xl p-2 shadow-sm border border-gray-100 flex flex-col gap-1">
                                ...
                                {user && (
                                    <button onClick={() => { closeDrawer(); handleLogOut(); }} className="flex items-center gap-3 py-2.5 px-3 text-sm text-red-600 hover:bg-red-50 rounded-xl transition-colors font-poppins w-full text-left">
                                        <FiLogOut size={18} />
                                        <span>Logout</span>
                                    </button>
                                )}
